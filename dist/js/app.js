 ...
 */
    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.required === "email") {
                    ...
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem); else if (formRequiredItem.name === "quantity") if (formRequiredItem.value.trim() !== "6") {
                    this.addError(formRequiredItem);
                    error++;
            ...
            removeError(formRequiredItem) {
                ...
                let inputError = formRequiredItem.parentElement.querySelector(".form__error");
                if (inputError && inputError.parentElement === formRequiredItem.parentElement) formRequiredItem.parentElement.removeChild(inputError);
            },
            formClean(form) {
                form.reset();
                setTimeout((() => {
            ...
            phoneTest(formRequiredItem) {
                return /^\+38\(0\d{2}\)\s\d{3}-\d{2}-\d{2}$/.test(formRequiredItem.value) && formRequiredItem.value.replace(/\D/g, "").length >= 9;
            },
        ...
        function formQuantity() {
            document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest("[data-quantity-plus]") || targetElement.closest("[data-quantity-minus]")) {
                    ...
                    const hasCustomLimit = quantityElement.classList.contains("custom-limit-plus");
                    let value = parseInt(valueElement.value);
                    if (targetElement.hasAttribute("data-quantity-plus")) {
                        if (!hasCustomLimit || value < 6) value++;
                    } else {
                        --value;
        ...
        if (document.querySelector("[data-datepicker]")) {
            ...
            const startDatePicker = datepicker_min("#startDatePicker", {
                ...
                onSelect: function(date, instance) {
                    ...
                    if (endDatePicker.selectedDates && endDatePicker.selectedDates.length > 0) {
                        ...
                        if (selectedEndDate && selectedEndDate < date) endDatePicker.setDate(date);
                    }
                }
            });
            const endDatePicker = datepicker_min("#endDatePicker", {
                customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Нд" ],
                customMonths: [ "Січ", "Лют", "Берез", "Квіт", "Трав", "Черв", "Лип", "Серп", "Верес", "Жовт", "Листоп", "Груд" ],
                overlayButton: "Застосувати",
                overlayPlaceholder: "Рік (4 цифри)",
        ...
        function initializeInputMask(inputElements) {
            if (inputElements && inputElements.length) inputElements.forEach((inputElement => {
                ...
                if (form) form.addEventListener("submit", (function(event) {
                    ...
                    if (maskedValue.length < 9) event.preventDefault();
                }));
            }));
        }
        ...
        function initSliders() {
            if (document.querySelector(".slider-select__slider")) new swiper_core_Swiper(".slider-select__slider", {
            ...
            if (document.querySelector(".slider-building__slider")) new swiper_core_Swiper(".slider-building__slider", {
            ...
            if (document.querySelector(".vibe__slider")) new swiper_core_Swiper(".vibe__slider", {
            ...
            if (document.querySelector(".infrastructure__slider")) new swiper_core_Swiper(".infrastructure__slider", {
                modules: [ Navigation, Pagination, EffectCoverflow, Autoplay ],
                observer: true,
                observeParents: true,
                loop: true,
            ...
            if (document.querySelector(".main-page__slider")) {
                let thumbsSwiper;
                thumbsSwiper = new swiper_core_Swiper(".main-page-thumb__slider", {
                    modules: [ Thumb, Controller, EffectFade ],
                    observer: true,
                    observeParents: true,
                    speed: 300,
                ...
                mySwiper = new swiper_core_Swiper(".main-page__slider", {
                    modules: [ Navigation, Pagination, EffectFade, Thumb, Autoplay ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
                ...
                function updateFraction() {
                    ...
                    if (fractionElement) fractionElement.innerHTML = `<span class='swiper-fraction-pagination__first'>${currentSlide}/</span><span class='swiper-fraction-pagination__second'>${totalSlides} </span>`;
                }
                updateFraction();
            }
        }
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            if (document.querySelector(".faq")) {
                ...
                let displayedQuestions = 4;
                for (let i = displayedQuestions; i < faqItems.length; i++) faqItems[i].style.display = "none";
                faqButton.addEventListener("click", (function() {
                    addMoreQuestions();
                }));
                function addMoreQuestions() {
                    const remainingQuestions = faqItems.length - displayedQuestions;
                    const questionsToAdd = Math.min(4, remainingQuestions);
                    for (let i = displayedQuestions; i < displayedQuestions + questionsToAdd; i++) faqItems[i].style.display = "block";
                    displayedQuestions += questionsToAdd;
                    if (displayedQuestions >= faqItems.length) faqButton.style.display = "none";
                }
            }
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            if (document.querySelector(".button-menu")) {
                ...
                document.addEventListener("click", (function(event) {
                    ...
                    var mainDiv = document.getElementById("main-button");
                    if (!mainDiv.contains(clickedElement) || clickedElement.classList.contains("main-button__link")) mainDiv.classList.remove("open");
                }));
            }
        }));
        if (document.querySelector(".arrow-up")) window.addEventListener("scroll", (function() {
